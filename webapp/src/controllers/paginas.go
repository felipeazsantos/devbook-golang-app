...
//CarregarPaginaDeCadastrarUsuario carrega a tela de cadastro de usuário
...
//CarregarPaginaDeAtualizarDePublicacao carrega página de edição da publicação
func CarregarPaginaDeAtualizarDePublicacao(w http.ResponseWriter, r *http.Request) {
...
//CarregarPaginaDeAtualizacaoDeSenha carrega a página de atualização de senha do usuário
