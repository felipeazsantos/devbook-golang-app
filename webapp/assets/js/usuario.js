...
function atualizarSenha(evento) {
    ...
    if ($("#nova-senha").val() != $("#confirmar-senha").val()) {
        Swal.fire("Ops...", "As senha não coincidem!", "warning");
        return;
    }
    ...
    Swal.fire({
        ...
        if (confirmacao.value) {
            $.ajax({
                ...
                Swal.fire("Ops...", "Erro ao excluir conta!", "error")
            });
        }
    })
}